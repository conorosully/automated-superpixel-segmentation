...
"""
This script tests the dataset generated by the apply_superpixels.py script."""
...
def main(folder_path, satellite_type, channels):
    if satellite_type == "landsat":
        expected_file_count = 30000
        expected_shape = (256, 256, channels)
...
if __name__ == "__main__":
    ...
    # include number of channels as an argument
    
    parser = argparse.ArgumentParser(description="Test the dataset generated by the apply_superpixels.py script.")
    parser.add_argument("--folder_path", type=str, required=True, help="Path to the folder containing the dataset")
    parser.add_argument("--satellite_type", type=str, required=True, help="Type of satellite data used to generate the dataset")
    parser.add_argument("--channels", type=int, required=True, help="Number of channels in the dataset")
